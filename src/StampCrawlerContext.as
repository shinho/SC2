package
{
      ...
      import com.shinho.commands.UpdateStampCommand;
      ...
      import com.shinho.views.pictureStripe.SeriesStripeMediator;
      ...
      public class StampCrawlerContext extends Context
      {
            ...
            override public function startup():void
            {
                  ...
                  commandMap.mapEvent( StampsDatabaseEvents.STAMPINFO_UPDATED, UpdateStampCommand, StampsDatabaseEvents );

                  // mediators
                  mediatorMap.createMediator( contextView );
                  mediatorMap.mapView( ApplicationMainView, ApplicationMediator );
                  mediatorMap.mapView( SeriesStripeView, SeriesStripeMediator );
